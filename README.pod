...
=head1 The Local module

This is the I<README> for the L<Local> Perl module. You're probably 
...
To read about L<Local>, look at the embedded documentation 
in the module itself. Inside the distribution, you can format it 
with L<perldoc|http://perldoc.perl.org/perldoc.html>:

	% perldoc lib/Local.pm
...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Local> or 
L<MetaCPAN|http://www.metacpan.org/module/Local>:

=over 4

=item *	L<http://search.cpan.org/dist/Local>

=item *	L<http://www.metacpan.org/module/Local>
